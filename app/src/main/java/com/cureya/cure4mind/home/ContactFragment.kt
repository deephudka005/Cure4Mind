...
import com.cureya.cure4mind.databinding.FragmentContactusBinding
import com.cureya.cure4mind.home.data.Contact
...
class ContactFragment : Fragment() {
    ...
    private fun showDialog(activity: Activity?, msg: String?) {
        ...
        dialog.setContentView(R.layout.alertcard)
        val text : TextView = dialog.findViewById(R.id.subtext_dialog)
        text.text = msg
        val dialogButton: Button = dialog.findViewById(R.id.btn)
